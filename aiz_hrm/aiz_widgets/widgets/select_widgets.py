...
This module is used to write aiz form select widgets
"""
...
class aizMultiSelectWidget(forms.Widget):
    """
    aizMultiSelectWidget
    """
    ...
    template_name = "aiz_widgets/aiz_multiselect_widget.html"
