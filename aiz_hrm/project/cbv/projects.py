...
from aiz_views.cbv_methods import login_required, permission_required
from aiz_views.generic.cbv.views import (
    aizCardView,
    aizFormView,
    aizListView,
    aizNavView,
...
class ProjectsNavView(aizNavView):
    """
    Nav bar
    """
...
class ProjectsList(aizListView):
    """
    Projects list view
    """
...
class ProjectFormView(aizFormView):
    """
...
class ProjectCardView(aizCardView):
    """
    For card view
    """
...
# Remove the command lines after aiz converted into CBV
