...
@method_decorator(login_required, name="dispatch")
class TaskListView(aizListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(aizFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(aizDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(aizCardView):
    """
