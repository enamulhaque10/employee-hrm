...
from aiz.filters import FilterSet, aizFilterSet, filter_by_name
from aiz.aiz_middlewares import _thread_locals
from aiz_documents.models import Document
from aiz_views.templatetags.generic_template_filters import getattribute


class EmployeeFilter(aizFilterSet):
    """
...
class EmployeeReGroup:
    ...
    fields = [
        ...
        ("employee_work_info__work_type_id", "Job Position"),
