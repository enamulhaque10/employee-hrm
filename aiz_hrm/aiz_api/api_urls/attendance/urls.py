"""
aiz_api/urls/attendance/urls.py
"""

from django.urls import path

from aiz_api.api_views.attendance.permission_views import AttendancePermissionCheck
from aiz_api.api_views.attendance.views import *
