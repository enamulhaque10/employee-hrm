...
from aiz.aiz_settings import DYNAMIC_URL_PATTERNS, aiz_DATE_FORMATS
from aiz.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = aiz_DATE_FORMATS.get(date_format)
