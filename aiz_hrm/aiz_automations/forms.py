...
from aiz_automations.methods.methods import generate_choices
from aiz_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["also_sent_to"] = aizMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], aizMultiSelectField):
