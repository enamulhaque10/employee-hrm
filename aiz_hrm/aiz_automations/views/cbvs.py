...
from aiz.decorators import login_required, permission_required
from aiz_automations import models
from aiz_automations.filters import AutomationFilter
from aiz_automations.forms import AutomationForm
from aiz_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("aiz_automation.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.aizSectionView):
    """
    ...
    template_name = "aiz_automations/section_view.html"
...
class AutomationNavView(views.aizNavView):
    """
    AutomationNavView
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("aiz_automation.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.aizFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "aiz_automations/automation_form.html"
...
class AutomationListView(views.aizListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.aizDetailedView):
    """
