...
class MailAutomation(aizModel):
    ...
    mail_template = models.ForeignKey(aizMailTemplate, on_delete=models.CASCADE)
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "aiz_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )

    def get_mail_cc_display(self):
        employees = self.also_sent_to.all()
        return render_template(
            "aiz_automations/mail_cc.html", {"employees": employees}
        )
    ...
    def conditions(self):
        return render_template(
            "aiz_automations/conditions.html", {"instance": self}
        )
