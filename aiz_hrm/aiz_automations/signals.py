...
from aiz.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from aiz_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=aizMailTemplate)
    @receiver(post_save, sender=aizMailTemplate)
...
def send_automated_mail(
    ...
    from aiz_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from aiz_automations.methods.methods import (
        get_model_class,
