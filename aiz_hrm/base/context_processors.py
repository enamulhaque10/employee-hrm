...
def white_labelling_company(request):
    ...
    if white_labelling:
        ...
        return {
            "white_label_company_name": company.company if company else "aiz",
            "white_label_company": company,
        }
    else:
        return {
            "white_label_company_name": "aiz",
...
def resignation_request_enabled(request):
    ...
    if apps.is_installed("offboarding"):
        OffboardingGeneralSetting = get_aiz_model_class(
...
def timerunner_enabled(request):
    ...
    if apps.is_installed("attendance"):
        AttendanceGeneralSetting = get_aiz_model_class(
...
def intial_notice_period(request):
    ...
    if apps.is_installed("payroll"):
        PayrollGeneralSetting = get_aiz_model_class(
...
def check_candidate_self_tracking(request):
    ...
    if apps.is_installed("recruitment"):
        RecruitmentGeneralSetting = get_aiz_model_class(
