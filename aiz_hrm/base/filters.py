...
Employee Section Requests, Rotating Shift and Rotating Employee Section Assign.
"""
...
from aiz.filters import FilterSet, filter_by_name
...
class RotatingWorkTypeAssignFilter(FilterSet):
    """
    Custom filter for Rotating Employee Section Assign.
    """
