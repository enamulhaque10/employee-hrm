...
urlpatterns = [
    ...
    path(
        "forgot-password",
        views.aizPasswordResetView.as_view(),
    ...
    path(
        "settings/employee-section-creation/",
        views.employee_section_creation,
        name="employee-section-creation",
    ),
    path(
    ...
    path(
        "settings/employee-section-view/",
        views.employee_section,
        name="employee-section-view",
    ),
    path(
    ...
    path(
        "settings/employee-section-update/<int:id>/",
        views.employee_section_update,
        name="employee-section-update",
        kwargs={"model": EmployeeSection},
    ),
    path(
    ...
    path(
        "employee-section-delete/<int:obj_id>/",
        views.object_delete,
        name="employee-section-delete",
        kwargs={
    ...
    path("settings/employee-unit-create/", views.employee_unit_create, name="employee-unit-create"),
    path("settings/job-role-view/", views.job_role_view, name="job-role-view"),
    path("settings/employee-unit-view/", views.employee_unit_view, name="employee-unit-view"),
    path(
    ...
    path(
        "settings/employee-unit-update/<int:id>/",
        views.employee_unit_update,
        name="employee-unit-update",
        kwargs={"model": EmployeeUnit},
    ),
    path(
    ...
    path(
        "employee-unit-delete/<int:obj_id>/",
        views.object_delete,
        name="employee-unit-delete",
        kwargs={
            "model": EmployeeUnit,
            "HttpResponse": True,
        },
    ...
    path(
        "get-aiz-installed-apps/",
        views.get_aiz_installed_apps,
        name="get-aiz-installed-apps",
    ),
