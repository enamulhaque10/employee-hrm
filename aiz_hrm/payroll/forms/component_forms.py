...
from aiz_widgets.forms import aizForm, orginal_template_name
...
class AllowanceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = aizMultiSelectField(
...
class GeneratePayslipForm(aizForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave"):
            AvailableLeave = get_aiz_model_class(
