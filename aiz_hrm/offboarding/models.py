...
class OffboardingStage(aizModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(aizModel):
    """
...
class OffboardingEmployee(aizModel):
    """
...
class ResignationLetter(aizModel):
    """
    ...
    def to_offboarding_employee(
        ...
        contract_notice_end_date = (
            get_aiz_model_class(app_label="payroll", model="contract")
...
class OffboardingTask(aizModel):
    """
...
class OffboardingNote(aizModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(aizModel):
    """
