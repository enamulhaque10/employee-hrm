...
class Asset(aizModel):
    ...
    objects = aizCompanyManager("asset_category_id__company_id")
...
class AssetAssignment(aizModel):
    """
    ...
    objects = aizCompanyManager("asset_id__asset_lot_number_id__company_id")
