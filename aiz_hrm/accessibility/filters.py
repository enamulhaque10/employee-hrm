...
from aiz.filters import aizFilterSet
...
class AccessibilityFilter(aizFilterSet):
    """
    ...
    verbose_name = {
        ...
        "employee_work_info__employee_section_id": _("Employee Section"),
        "employee_work_info__department_id": _("Department"),
        "employee_work_info__work_type_id": _("Work Type"),
        "employee_work_info__employee_type_id": _("Employee Category"),
