...
from aiz.filters import FilterSet
from aiz.group_by import group_by_queryset
from aiz.aiz_middlewares import _thread_locals
from aiz_views import models
from aiz_views.cbv_methods import (  # update_initial_cache,
    get_short_uuid,
    hx_request_required,
    paginator_qry,
    sortby,
...
from aiz_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from aiz_views.templatetags.generic_template_filters import getattribute


@method_decorator(hx_request_required, name="dispatch")
class aizListView(ListView):
    """
    aizListView
    """
    ...
    template_name: str = "generic/aiz_list_table.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # # update_initial_cache(request, CACHE, aizListView)
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[aizListView] = context
        from aiz.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class aizListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = aizListViewResorce()
...
class aizSectionView(TemplateView):
    """
    aiz Template View
    """
    ...
    template_name = "generic/aiz_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class aizDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/aiz_detailed_view.html"
    header: dict = {
        "title": "aiz",
        "subtitle": "aiz Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, aizDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class aizTabView(TemplateView):
    """
    aizTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/aiz_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, aizTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[aizTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class aizCardView(ListView):
    """
    aizCardView
    """
    ...
    template_name = "generic/aiz_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, aizCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[aizCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
class aizFormView(FormView):
    ...
    template_name = "generic/aiz_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, aizFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[aizFormView] = form
            self.form = form
        return self.form


@method_decorator(hx_request_required, name="dispatch")
class aizNavView(TemplateView):
    """
    aizNavView
    ...
    template_name = "generic/aiz_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, aizNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[aizNavView] = context
        return context


@method_decorator(hx_request_required, name="dispatch")
class aizProfileView(DetailView):
    """
    GenericaizProfileView
    """

    template_name = "generic/aiz_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, aizProfileView)
