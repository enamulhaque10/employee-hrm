...
from aiz.signals import post_generic_delete, pre_generic_delete
from aiz_views import models
from aiz_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from aiz_views.forms import SavedFilterForm
from aiz_views.generic.cbv.views import aizFormView, aizListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.aizModel = dynamic_cache["model"]
...
class DynamiListView(aizListView):
    """
...
class aizDeleteConfirmationView(View):
    """
