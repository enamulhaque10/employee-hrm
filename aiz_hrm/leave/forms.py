"""
This module provides aiz ModelForms for creating and managing leave-related data,
...
from aiz_widgets.forms import aizForm, aizModelForm
...
class LeaveOneAssignForm(aizModelForm):
    """
    ...
    Attributes:
        - employee_id: A aizMultiSelectField representing the employee to assign leave to.
    """
