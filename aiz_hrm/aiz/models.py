...
This module defines the abstract base model `aizModel` for the aiz HRMS project.
The `aizModel` provides common fields and functionalities for other models within
...
class aizModel(models.Model):
    ...
    aiz_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for aizModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(aizModel, self).save(*args, **kwargs)
...
auditlog.register(aizModel, serialize_data=True)
