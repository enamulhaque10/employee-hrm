...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = aizMultiSelectField(
        ...
        self.fields["managers"] = aizMultiSelectField(
            queryset=Employee.objects.all(),
            widget=aizMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # aiz multi select filter for employee
        self.fields["subordinate_id"] = aizMultiSelectField(
            queryset=Employee.objects.all(),
            widget=aizMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
