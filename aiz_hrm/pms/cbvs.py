...
class BonusPointSettingSectionView(views.aizSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.aizNavView):
    """
...
class BonusPointSettingFormView(views.aizFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.aizListView):
    """
...
class EmployeeBonusPointSectionView(views.aizSectionView):
    """
...
class EmployeeBonusPointNavView(views.aizNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.aizFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.aizListView):
    """
    BnusPoint list view
    """
