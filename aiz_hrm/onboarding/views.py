...
from base.models import aizMailTemplate, JobPosition
...
from aiz.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = aizMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        aizMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
